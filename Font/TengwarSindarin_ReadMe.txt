...
This READ-ME file is to accompany the following file:
  ...
  TengwarSindarin_v19E.zip "Tengwar Sindarin" font pack for Windows (version 1.9e)

  ©copyright - 1993-2003 - Daniel Steven Smith
  fontmaster.geo@yahoo.com 
...
the Elvish Tengwar alphabet.  They can be used to write Elf language 
inscriptions with Windows applications. (The Tengwar alphabet was devised by 
J.R.R. Tolkien and used by the Elves to write in their native languages).
...
================================================================================
The Windows Truetype Font file for "Tengwar Sindarin":
	TengwarSindarin.ttf 
	TengwarSindarinAlt.ttf
	TengwarSindarinCapitals1.ttf 
	TengwarSindarinCapitals2.ttf 
Postscript versions of the same fonts:
	TengwarSindarinPostscript.zip
Help Files:
	TengwarSindarin_Help.pdf
	TengwarSindarin_KeyboardMap.pdf
...
Please now open and read my Tengwar Help files.  They explain the various 
different modes and keyboard mappings.  
...
Special Note on the commercial use of Tengwar fonts
--------------------------------------------------------------------------------
Decades ago, J.R.R. Tolkien invented the Tengwar and Cirth alphabets. They are 
his intellectual property. They are part of the legacy that he left to his heirs 
and their legal representatives. Among these legal representatives are 
Authorized Publishers, Merchandisers and the Tolkien Estate.

The Tolkien Estate has most graciously granted permission to Dan Smith to freely 
distribute his Tolkien-inspired fonts on the Internet. If you want to use Dan 
Smith's Tengwar fonts in a commercial product or publication, you will need to 
get formal permission from one of the following authorities:

    * Publishers: "http://www.tolkiensociety.org/links.html#publishers"
    * Merchandiser: "http://www.tolkien-ent.com/new/index.html"
    * Tolkien Estate: "http://www.elvish.org/resources.html"
